...
public class FastCash extends JFrame implements ActionListener{
    ...
    JButton oneHundred,twoHundred, fiveHundred,oneMillion,twoMillion,fiveMillion,back;
    Card card;
    Account account;
    
    FastCash(Card card,Account account){
        this.card =card;
        ...
        JLabel title = new JLabel("ENTER AMOUNT TO BORROW");
